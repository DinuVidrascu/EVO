...
function App() {
  ...
  return (
    <>
      <AIChatModal open={aiChatOpen} onClose={() => setAiChatOpen(false)} tasks={tasks} />
      <Sidebar setView={setActiveView} activeView={activeView} toggleTheme={toggleTheme} theme={theme} onOpenAI={() => setAiChatOpen(true)} />
